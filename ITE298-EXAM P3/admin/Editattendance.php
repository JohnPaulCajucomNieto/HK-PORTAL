...
<?php
         ...
         $ID = $_GET['id'];
         $qry = mysqli_query($conn,"select * from HK_ATTENDANCE where id='$ID'");
    ...
    <section class="header-widht"> 
        ...
        <div class="modal-content">
            ...
            <form action="../admin/EditValidation.php" method="GET">
                <input class="input-id"  type="text" name="ID" id="ID" placeholder="Student Number" value="<?php echo $row["ID"]?>">
               
                <input class="input-name"  type="text" name="name" id="name" placeholder="Name" value="<?php echo $row["Name"]?>">
                
                <input class="input-course" type="text" name="course" id="course" placeholder="Course" value="<?php echo $row["Course"]?>">

                <input class="input-section" type="text" name="section" id="section" placeholder="Section" value="<?php echo $row["Section"]?>">

                <input class="input-year" type="text" name="year" id="year" placeholder="Year" value="<?php echo $row["Year"]?>">

                <label class="start-description" >Duty-start</label>
                <input class="input-duty-start" type="time" name="dutystart" id="dutystart" value="<?php echo $row["DutyStart"]?>"><br>

                <label class="end-description">Duty-end</label>
                <input class="input-duty-end" type="time" name="dutyend" id="dutyend" value="<?php echo $row["DutyEnd"]?>"><br>

                <label class="date-description" >Date</label>
                <input class="input-date" type="date" name="scheddate" id="scheddate" value="<?php echo $row["SchedDate"]?>"><br>

                <label class="attendance-description">Attendance</label>
                <select class="dropdown" name="attendance" id="attendance" value="<?php echo $row["Attendance"]?>">
            ...
            <button class="btn" type="submit" value="Submit"><i class="fa-solid fa-calendar-plus"></i> UPDATE </button>
            </form>
        </div>
        </div>
    </section>
