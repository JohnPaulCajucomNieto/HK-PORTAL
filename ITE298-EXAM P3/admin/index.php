  ...
  <body>
    ...
    <section class="header2">
        <div class="header-container-2">
           <div class="img-name">
            <h1 class="logo-name">WELCOME TO STUDENT HK PORTAL | HK ATTENDANCE</h1>
           </div>
           <div class="links-2">
            <a class="SCHOLARS" href="../admin/index.php"><i class="fa-solid fa-clipboard-user"></i><span class="attendance">ATTENDANCE</a>
            <a class="SCHOLARS" href="../scholars/scholars.php"><i class="fa-sharp fa-solid fa-user-graduate"></i>SCHOLARS</a>
    ...
    <?php
            ...
            if ($result->num_rows > 0) {
                ...
                <tr>
                    ...
                    <td>".$row["Reasons"]."</td> 
                    <td><a href='Editattendance.php?id=$ID'>Edit</a> |
